...
class Dermatologist(models.Model):
    """
    Model representing a dermatologist.
    """

    user = models.OneToOneField(User, on_delete=models.CASCADE)
    qualification = models.ImageField(upload_to='media/qualification/%Y/%m/%d/')
    specialization = models.CharField(max_length=100, default="DERMATOPATHOLOGIST", choices=[
        ("COSMETIC", "Cosmetic Dermatologist"),
        ("DERMATOPATHOLOGIST", "Dermatopathologist"),
        ("DERMATOSURGEON", "Dermatosurgeon"),
        ("IMMUNODERMATOLOGIST", "Immunodermatologist"),
        ("MOHS_SURGEON", "Mohs Surgeon"),
        ("PAEDIATRIC", "Paediatric Dermatologist"),
        ("TELEDERMATOLOGIST", "Teledermatologist")
    ])
    ...
    def __str__(self):
        """
        Returns the string representation of the dermatologist.
        """
