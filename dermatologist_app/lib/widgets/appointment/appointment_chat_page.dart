...
import 'package:dermatologist_app/models/chat_message.dart';
...
import 'package:dermatologist_app/widgets/common/common.dart';
...
class _AppointmentChatPageState extends State<AppointmentChatPage> {
  ...
  void fieldChanged() {
    _bloc.chatAppointmentIsDirty =
        _bloc.chat?.appointment.appoTime.toString() != dateController.text ||
  ...
  Widget _buildAppointmentCard() {
    if (!initialized) {
      durationController = TextEditingController(
          text: _bloc.chat!.appointment.duration?.inHours.toString());
      costController =
          TextEditingController(text: _bloc.chat!.appointment.cost.toString());
      extraInfoController =
          TextEditingController(text: _bloc.chat!.appointment.extraInfo);
      dateController = TextEditingController(
          text: _bloc.chat!.appointment.appoTime?.toString());
      initialized = true;
    }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: _bloc.state is UpdatingAppointment
            ...
            : Column(
                ...
                children: [
                  ...
                  if (_isExpanded)
                    _bloc.state is UpdatingAppointment
                        ? const LoadingIndicator()
                        : Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: !_bloc.chatAppointmentIsDirty
                                        ? null
                                        : !isDirty
                                            ? null
                                            : () {
        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              child: _bloc.state is AppointmentChatMessageSending
                  ? const LoadingIndicator()
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AppointmentChatBloc, AppointmentChatState>(
      ...
      builder: (context, state) {
        if (state is AppointmentChatInitial ||
            state is AppointmentChatLoading) {
          return const Center(
